...
const products = [
    ...
    { nome: 'KIFOL CUPRATIL', unidade: 'GL', preco: 535 },
    { nome: 'KIFOL CUPRATIL', unidade: 'LT', preco: 115 },
    { nome: 'KIFOL ZINFOL', unidade: 'GL', preco: 535 },
    { nome: 'KIFOL ZINFOL', unidade: 'LT', preco: 115 },
    { nome: 'KIFOL TEKS', unidade: 'GL', preco: 395 },
    { nome: 'KIFOL TEKS', unidade: 'LT', preco: 85 },
    { nome: 'KIFOL AMINO FLOWER', unidade: 'GL', preco: 395 },
    { nome: 'KIFOL AMINO FLOWER', unidade: 'LT', preco: 85 },
    { nome: 'KIFOL BORO 10%', unidade: 'GL', preco: 395 },
    { nome: 'KIFOL BORO 10%', unidade: 'LT', preco: 85 },
    { nome: 'KIFOL KIPHO-30', unidade: 'GL', preco: 280 },
    { nome: 'KIFOL KIPHO-30', unidade: 'LT', preco: 61 },
    { nome: 'KIFOL FOSFITO 40-20', unidade: 'GL', preco: 395 },
    { nome: 'KIFOL FOSFITO 40-20', unidade: 'LT', preco: 85 },
    ...
    { nome: 'KIFOL STRIKE', unidade: 'KG', preco: 73 },
    { nome: 'KIFOL CALCIO 27%', unidade: 'KG', preco: 73 },
    { nome: 'KIFOL 09-50-10', unidade: 'KG', preco: 73 },
    { nome: 'KIFOL MICROS', unidade: 'KG', preco: 73 },
    { nome: 'KIFOL 00-10-50', unidade: 'KG', preco: 73 },
